...
INSERT INTO `charge` (`idcharge`, `persen`) VALUES
(1, '5');
...
INSERT INTO `customer` (`idcustomer`, `namacust`, `email`, `ktp`, `alamat`, `contact`, `picture`) VALUES
...
INSERT INTO `info` (`idinfo`, `namaapp`, `picture`, `address`, `city`, `country`, `poscode`, `phone`, `slogan`, `thanks`, `logo`, `zone`, `email`, `currency`) VALUES
...
INSERT INTO `kategori` (`idkatego`, `namakategori`, `created`, `counter`) VALUES
...
INSERT INTO `keranjang` (`idkeranjang`, `kodesewa`, `created`, `idproduct`, `id_mitra`, `hrg`, `qty`, `total`, `status`) VALUES
...
INSERT INTO `liburnasional` (`id_liburan`, `tanggal_liburan`, `keterangan_liburan`, `diskon`) VALUES
...
INSERT INTO `product` (`idproduct`, `namaproduct`, `stock`, `created`, `kodebarang`, `brand`, `detail`, `picture`, `batassewa`, `hargasewa`, `pemilik`, `contact`, `id_kategori`, `status`, `kodesewa`, `tglsewa`, `tglkembali`, `counter`) VALUES
...
INSERT INTO `settinglang` (`idsetlang`, `nameset`, `status`, `idadmin`) VALUES
(1, 'English', 'Default', '1'),
(2, 'French', '', '1'),
(3, 'Arab', '', '1');
...
INSERT INTO `sewa` (`idsewa`, `tglsewa`, `tanggal`, `tglkembali`, `id_mitra`, `id_users`, `namausers`, `contact`, `alamat`, `ktp`, `jaminan`, `email`, `kodesewa`, `harga`, `status`, `diskon`, `hargadiskon`, `id_diskon`, `keterangan`) VALUES
...
--
-- AUTO_INCREMENT for table `settinglang`
--
ALTER TABLE `settinglang`
